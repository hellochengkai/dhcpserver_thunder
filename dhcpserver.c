...
int serve_dhcp_discover(dhcp_msg *request, dhcp_msg *reply)
{
...
int serve_dhcp_request(dhcp_msg *request, dhcp_msg *reply)
{
    address_binding *binding = search_binding(&pool.bindings, request->hdr.chaddr,
    ...
    { // answer to the offer of another server
...
int serve_dhcp_decline(dhcp_msg *request, dhcp_msg *reply)
{
    address_binding *binding = search_binding(&pool.bindings, request->hdr.chaddr,
                                              request->hdr.hlen, STATIC_OR_DYNAMIC, PENDING);
...
int serve_dhcp_release(dhcp_msg *request, dhcp_msg *reply)
{
    address_binding *binding = search_binding(&pool.bindings, request->hdr.chaddr,
...
int serve_dhcp_inform(dhcp_msg *request, dhcp_msg *reply)
{
